...
%     sensorLines.z = z_cone;
    ...
    sensorLines.balloon_line.x = x_cone_S_line;
    sensorLines.balloon_line.y = rangeToF_S_line;
    sensorLines.balloon_line.z = z_cone_S_line;
    
    sensorLines.gondola_line.x = Gx_cone_line;
    sensorLines.gondola_line.y = GrangeToF_line;
    sensorLines.gondola_line.z = Gz_cone_line;
end